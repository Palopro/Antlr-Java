...
/**
 * This class provides an empty implementation of {@link TypesVisitor},
 ...
 */
public class TypesBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements TypesVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
